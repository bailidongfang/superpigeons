...
from other_apps.ckeditor_uploader.forms import SearchForm
from other_apps.ckeditor_uploader import image_processing, utils
...
class ImageUploadView(generic.View):
    ...
    def post(self, request, **kwargs):
        ...
        # 上传文件名随机前缀
        uploaded_file.name = ''.join(random.sample(string.ascii_letters + string.digits, 8))+'_'+uploaded_file.name
...
def browse(request):
    ...
    return render(request, 'ckeditor/templates/ckeditor/browse.html', context)
